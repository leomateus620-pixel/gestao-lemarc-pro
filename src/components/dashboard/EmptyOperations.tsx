...
export function EmptyOperations() {
  return (
    <section className="relative mt-5 overflow-hidden rounded-[1.75rem] border border-dashed border-white/[0.14] bg-white/[0.025] px-6 py-14 shadow-[inset_0_1px_0_oklch(1_0_0/0.08)] sm:py-16">
      <div
