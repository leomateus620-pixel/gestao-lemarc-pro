...
DO $$ BEGIN IF to_regtype('public.app_module') IS NULL THEN CREATE TYPE public.app_module AS ENUM ('os', 'wire_trays'); END IF; END $$;
DO $$ BEGIN IF to_regtype('public.wire_tray_module_role') IS NULL THEN CREATE TYPE public.wire_tray_module_role AS ENUM ('admin', 'gestor', 'comercial', 'producao', 'estoque', 'faturamento', 'consulta'); END IF; END $$;
